...
/**
 * @author              :   Draxayani
 * Test Reference No	: 	A065 CP Company controls
 * Purpose              :   Amend CP Company Controls.
 * Date					:   23-06-2014/Modified on 25-Apr-2017 (Chetna)
 * ACCESS               :   PAA
 */

public class A065_CP_Company_ControlsTest extends BaseTest{
	/*Launch the browser*/
	@BeforeClass
...
//		Assert.assertEquals(testcases,currencyPage.getTableHeader(), "M"+currencyCode+" - Purchasing Company Controls Li","Currency search page","displayed");
		...
		currencyPage.editCommonPurchasingComany(companyId, purchasingCompany);	
