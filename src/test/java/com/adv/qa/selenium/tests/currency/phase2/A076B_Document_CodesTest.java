...
public class A076B_Document_CodesTest extends BaseTest{
	/*Launch the browser*/
	@BeforeClass
	...
	public void verify(DataRow dataRow) throws InterruptedException{
		...
		List<String> documentCodeRR = dataRow.findNamesReturnValues("documentCodeRR");
		List<String> documentCodeRi = dataRow.findNamesReturnValues("documentCodeRi");
		List<String> documentCodeRT = dataRow.findNamesReturnValues("documentCodeRT");
		List<String> documentCodeSR = dataRow.findNamesReturnValues("documentCodeSR");
		List<String> documentCodeTR = dataRow.findNamesReturnValues("documentCodeTR");
		...
		createBatchType(currencyPage,dataRow,documentCodeRR);
		createBatchType(currencyPage,dataRow,documentCodeRi);
		createBatchType(currencyPage,dataRow,documentCodeRT);
		createBatchType(currencyPage,dataRow,documentCodeSR);
		createBatchType(currencyPage,dataRow,documentCodeTR);
...
//		String message = "The previously-requested action has been performed";
		...
		boolean update = currencyPage.enterDocumentCodeDetails(documentList);
		
//		currencyPage.enterDocumentCodeDetails(enterDocumentCodeDetails);
...
//		}
	...
	public Object[][] dp() 
	{
		...
		String xmlFilePath = folder  + "A076B.xml";
