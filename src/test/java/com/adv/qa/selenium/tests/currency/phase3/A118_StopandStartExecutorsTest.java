...
/**
 * @author              :   Chetna
 * Test Reference No	: 	A11 Simplified Security   
 * Date					:	02-June-2017      
 * ACCESS               :   AQD
 * (As per Paul) To ensure the fail doesn't happen again I think you'll need to add a test, after A117, 
 * to log out of the system log back in (not resume) and stop and start the executors.
 * 
 */
...
public class A118_StopandStartExecutorsTest extends BaseTest{
	...
	public void verify(DataRow dataRow) throws InterruptedException{
		...
		Assert.assertEquals(testcases,currencyPage.getTableHeader(), "M"+currencyCode+" - Region List","Currency search page","displayed");
	...
	public void submitProcess(CurrencyPageNew currencyPage,List<String> processList,int i) throws InterruptedException{
		...
		Assert.assertTrue(testcases,value,"Precess "+processList.get(2)," performed on request"+processList.get(1));
