...
/**
 * @author              :   Draxayani
 * Test Reference No	: 	A061 Purchasing Management Locations
 * Purpose              :   Insert PM Locations
 * Date					:   19-06-2014/Modified 24-Apr-2017 (Chetna)
 * ACCESS               :   AK2
 */

public class A061_Purchasing_Management_LocationsTest extends BaseTest{
	/*Launch the browser*/
	@BeforeClass
	...
	public void verify(DataRow dataRow) throws InterruptedException{
		...
		List<String> locationHQ = dataRow.findNamesReturnValues("locationHQ");
		List<String> locationEastHQ = dataRow.findNamesReturnValues("locationEastHQ");
		List<String> locationWestHQ = dataRow.findNamesReturnValues("locationWestHQ");
		List<String> locationSouthHQ = dataRow.findNamesReturnValues("locationSouthHQ");
		List<String> locationNorthHQ = dataRow.findNamesReturnValues("locationNorthHQ");
		...
		createPurchasingManagement(currencyPage,locationHQ);
		createPurchasingManagement(currencyPage,locationEastHQ);
		createPurchasingManagement(currencyPage,locationWestHQ);
		createPurchasingManagement(currencyPage,locationSouthHQ);
		createPurchasingManagement(currencyPage,locationNorthHQ);
...
//		}
	...
	{		
		...
		String[] nodeID = { "A061" };
		String [] selectedNames = {"userName","passWord","currencyCode","locationHQ","locationEastHQ","locationWestHQ","locationSouthHQ","locationNorthHQ",
